...
class PaypalProCheckoutNvpPaymentFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $rc = new \ReflectionClass('Payum2\Bundle\PayumBundle\DependencyInjection\Factory\Payment\PaypalProCheckoutNvpPaymentFactory');
    ...
    public function shouldDecorateBasicApiDefinitionAndAddItToPayment()
    {
        ...
        $this->assertTrue($container->hasDefinition('payum2.context.aContextName.api'));

        $this->assertDefinitionContainsMethodCall(
            $container->getDefinition($paymentId),
            'addApi',
            new Reference('payum2.context.aContextName.api')
        );
    }

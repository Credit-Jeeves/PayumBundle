...
class PaypalExpressCheckoutNvpPaymentFactory extends AbstractPaymentFactory
{
    ...
    public function create(ContainerBuilder $container, $contextName, array $config)
    {
        ...
        $apiDefinition = new DefinitionDecorator('payum2.paypal.express_checkout_nvp.api');
        ...
        $authorizeTokenDefinition = new DefinitionDecorator('payum2.paypal.express_checkout_nvp.action.api.authorize_token');
        $authorizeTokenId = 'payum2.context.'.$contextName.'.action.api.authorize_token';
        ...
        $doExpressCheckoutPaymentDefinition = new DefinitionDecorator('payum2.paypal.express_checkout_nvp.action.api.do_express_checkout_payment');
        $doExpressCheckoutPaymentId = 'payum2.context.'.$contextName.'.action.api.do_express_checkout_payment';
        ...
        $getExpressCheckoutDetailsDefinition = new DefinitionDecorator('payum2.paypal.express_checkout_nvp.action.api.get_express_checkout_details');
        $getExpressCheckoutDetailsId = 'payum2.context.'.$contextName.'.action.api.get_express_checkout_details';
        ...
        $getTransactionDetailsDefinition = new DefinitionDecorator('payum2.paypal.express_checkout_nvp.action.api.get_transaction_details');
        $getTransactionDetailsId = 'payum2.context.'.$contextName.'.action.api.get_transaction_details';
        ...
        $setExpressCheckoutDefinition = new DefinitionDecorator('payum2.paypal.express_checkout_nvp.action.api.set_express_checkout');
        $setExpressCheckoutId = 'payum2.context.' . $contextName . '.action.api.set_express_checkout';
        ...
        $createRecurringPaymentProfileDefinition = new DefinitionDecorator('payum2.paypal.express_checkout_nvp.action.api.create_recurring_payment_profile');
        $createRecurringPaymentProfileId = 'payum2.context.' . $contextName . '.action.api.create_recurring_payment_profile';
        ...
        $getRecurringPaymentsProfileDetailsDefinition = new DefinitionDecorator('payum2.paypal.express_checkout_nvp.action.api.get_recurring_payments_profile_details');
        $getRecurringPaymentsProfileDetailsId = 'payum2.context.' . $contextName . '.action.api.get_recurring_payments_profile_details';
        ...
        $manageRecurringPaymentsProfileStatusDefinition = new DefinitionDecorator('payum2.paypal.express_checkout_nvp.action.api.manage_recurring_payments_profile_status');
        $manageRecurringPaymentsProfileStatusId = 'payum2.context.' . $contextName . '.action.api.manage_recurring_payments_profile_status';
        ...
        $captureDefinition = new DefinitionDecorator('payum2.paypal.express_checkout_nvp.action.capture');
        ...
        $paymentDetailsStatusDefinition = new DefinitionDecorator('payum2.paypal.express_checkout_nvp.action.payment_details_status');
        $paymentDetailsStatusId = 'payum2.context.' . $contextName . '.action.payment_details_status';
        ...
        $syncDefinition = new DefinitionDecorator('payum2.paypal.express_checkout_nvp.action.payment_details_sync');
        $syncId = 'payum2.context.' . $contextName . '.action.payment_details_sync';
        $container->setDefinition($syncId, $syncDefinition);
        $paymentDefinition->addMethodCall('addAction', array(new Reference($syncId)));

        $recurringPaymentDetailsStatusDefinition = new DefinitionDecorator('payum2.paypal.express_checkout_nvp.action.recurring_payment_details_status');
        $recurringPaymentDetailsStatusId = 'payum2.context.' . $contextName . '.action.recurring_payment_details_status';
        ...
        $recurringPaymentDetailsSyncDefinition = new DefinitionDecorator('payum2.paypal.express_checkout_nvp.action.recurring_payment_details_sync');
        $recurringPaymentDetailsSyncsId = 'payum2.context.' . $contextName . '.action.recurring_payment_details_sync';
